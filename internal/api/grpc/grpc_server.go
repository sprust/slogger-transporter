...
import (
	...
	"log/slog"
	"net"
	"slogger/internal/api/grpc/gen/services/grpc_manager_gen"
	"slogger/internal/api/grpc/gen/services/ping_pong_gen"
	"slogger/internal/api/grpc/gen/services/trace_collector_gen"
	"slogger/internal/api/grpc/gen/services/trace_transporter_gen"
	"slogger/internal/api/grpc/services/grpc_manager"
	"slogger/internal/api/grpc/services/ping_pong"
	"slogger/internal/api/grpc/services/trace_collector"
	"slogger/internal/api/grpc/services/trace_transporter"
