...
type TraceTransporterPushRequest struct {
...
func (x *TraceTransporterPushRequest) Reset() {
	*x = TraceTransporterPushRequest{}
	mi := &file_internal_api_grpc_proto_trace_transporter_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TraceTransporterPushRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TraceTransporterPushRequest) ProtoMessage() {}

func (x *TraceTransporterPushRequest) ProtoReflect() protoreflect.Message {
	mi := &file_internal_api_grpc_proto_trace_transporter_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use TraceTransporterPushRequest.ProtoReflect.Descriptor instead.
func (*TraceTransporterPushRequest) Descriptor() ([]byte, []int) {
	return file_internal_api_grpc_proto_trace_transporter_proto_rawDescGZIP(), []int{0}
}

func (x *TraceTransporterPushRequest) GetPayload() string {
	if x != nil {
		return x.Payload
	}
	return ""
...
var file_internal_api_grpc_proto_trace_transporter_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x22, 0x37, 0x0a, 0x1b, 0x54, 0x72, 0x61, 0x63, 0x65, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x50, 0x75, 0x73, 0x68, 0x52, 0x65,
	...
	,
}
...
var file_internal_api_grpc_proto_trace_transporter_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_api_grpc_proto_trace_transporter_proto_goTypes = []any{
	(*TraceTransporterPushRequest)(nil), // 0: slogger_transporter.TraceTransporterPushRequest
	(*TraceTransporterResponse)(nil),    // 1: slogger_transporter.TraceTransporterResponse
}
var file_internal_api_grpc_proto_trace_transporter_proto_depIdxs = []int32{
	0, // 0: slogger_transporter.TraceTransporter.Push:input_type -> slogger_transporter.TraceTransporterPushRequest
	1, // 1: slogger_transporter.TraceTransporter.Push:output_type -> slogger_transporter.TraceTransporterResponse
